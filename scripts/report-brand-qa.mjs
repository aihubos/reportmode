...
if ((archive.match(/https:\/\/daangn\.com\/kr\/share\/community\/ref\/invite-group\/baRr2nojJVT\?utm_campaign=share_qr/g) || []).length !== 2) failures.push("archive/index.html: 당근모임 링크가 2개가 아님");
if (!archive.includes('class="archive-carrot-card"') || !archive.includes('src="../assets/daangn-meeting-logo.png"')) failures.push("archive/index.html: 당근모임 로고 카드가 없음");
