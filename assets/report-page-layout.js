(function(){
  ...
  if (!document.querySelector('script[src*="report-hub-brand.js"]')) {
    ...
    brandScript.src = layoutScript && layoutScript.src
      ? new URL("report-hub-brand.js?v=20260810-mobile-scroll1", layoutScript.src).href
      : "https://aihubos.github.io/reportmode/assets/report-hub-brand.js?v=20260810-mobile-scroll1";
