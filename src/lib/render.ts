    ...
    <div class="archive-topbar-inner">
      ...
      <div class="archive-topbar-actions">
        <div class="archive-topbar-links">
          ...
          <a class="archive-guidebook-card" href="https://www.figma.com/design/iazKT2P4SlHppnzZxtGynB/AI-%EB%B9%8C%EB%8D%94%EC%8A%A4-%EB%9E%A9-%C2%B7-%EB%8B%B9%EA%B7%BC%EB%AA%A8%EC%9E%84-%EA%B5%90%EC%9E%AC-%C2%B7-%EC%9B%8C%EB%93%9C%ED%81%B4%EB%9D%BC%EC%9A%B0%EB%93%9C---Hermes-%EC%8B%A4%EC%8A%B5-10%EA%B0%95?node-id=0-1&amp;t=d8eYqzih9gJkFOWh-1" target="_blank" rel="noopener noreferrer" aria-label="가이드북 Hermes, LLM Wiki 설치 열기"><span class="archive-guidebook-mark" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M4 5.5A2.5 2.5 0 0 1 6.5 3H11v17H6.5A2.5 2.5 0 0 0 4 22V5.5Z"></path><path d="M20 5.5A2.5 2.5 0 0 0 17.5 3H13v17h4.5A2.5 2.5 0 0 1 20 22V5.5Z"></path></svg></span><span class="archive-guidebook-copy">[가이드북] Hermes,<br>LLM Wiki 설치</span></a>
...
${tagLinks}
      ...
      <section class="request-board" id="request-board" aria-labelledby="request-board-title">
